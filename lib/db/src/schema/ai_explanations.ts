...
export const aiExplanationsTable = pgTable("ai_explanations", {
  ...
  forensicRiskHypothesis: text("forensic_risk_hypothesis"),
  isa240Mapping: text("isa_240_mapping"),
  recommendedSubstantiveAction: text("recommended_substantive_action"),

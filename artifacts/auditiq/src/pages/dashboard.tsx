import {
  useGetOverallDashboard,
  getGetOverallDashboardQueryKey,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Aggregate risk metrics across all active engagements.
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {dashboard.activeEngagements}
            </div>
            <p className="text-xs text-muted-foreground">
              Out of {dashboard.totalEngagements} total
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">
              {dashboard.totalHighRisk.toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-amber-500">
              {dashboard.totalMediumRisk.toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
              Requires sample review
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-500">
              {dashboard.totalLowRisk.toLocaleString()}
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4">
          <CardHeader>
            ...
            <CardDescription>
              Recently updated audit engagements
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {eng.clientName} &middot; {eng.period}
                    </div>
                  </div>
        ...
        <Card className="col-span-3">
          ...
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <div className="text-xl font-medium">
              {dashboard.overallRiskTrend || "Stable"}
            </div>
            <p className="text-sm text-muted-foreground text-center mt-2 max-w-xs">
              Based on recent journal entry analysis across all active audit
              engagements.
            </p>
          </CardContent>
        </Card>
